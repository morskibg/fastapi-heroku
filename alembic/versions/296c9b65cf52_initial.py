...
Revision ID: 296c9b65cf52
Revises: 
Create Date: 2021-11-03 14:26:37.792821
...
def upgrade():
    ...
    op.create_index(op.f('ix_contractor_address'), 'contractor', ['address'], unique=False)
    op.create_index(op.f('ix_contractor_eik'), 'contractor', ['eik'], unique=False)
    ...
    sa.Column('itn', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_itn_meta_itn'), 'itn_meta', ['itn'], unique=False)
    op.create_table('itnschedule',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('itnschedule')
    op.drop_index(op.f('ix_itn_meta_itn'), table_name='itn_meta')
    ...
    op.drop_index(op.f('ix_contractor_address'), table_name='contractor')
